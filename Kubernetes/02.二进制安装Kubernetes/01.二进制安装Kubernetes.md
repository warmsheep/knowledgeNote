...
| :-- | :-- | :-- | :-- | :-- | :-- |
| centos-7.2 | 192.168.0.2 | master | >=2 | >=2G | master1 |
| centos-7.2 | 192.168.0.3 | master | >=2 | >=2G | master2 |
| centos-7.2 | 192.168.0.4 | master | >=2 | >=2G | master3 |
| centos-7.2 | 192.168.0.5 | worker | >=2 | >=2G | worker1 |
| centos-7.2 | 192.168.0.6 | worker | >=2 | >=2G | worker2 |
